          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 bg-white/10 border border-white/20 rounded-full px-4 py-2.5 text-white placeholder-white/50 focus:outline-none focus:ring-1 focus:ring-[#C99A3C] text-sm"
                required
              />
              <button
                type="submit"
                className="bg-[#C99A3C] text-[#0F1B3D] px-6 py-2.5 rounded-full font-bold hover:bg-[#D4A84B] hover:shadow-[0_0_25px_rgba(201,154,60,0.4)] transition-all duration-300 text-sm whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
